...
This Pulse report shows the same number of commits and 1 additional author. Since our total unique authors count is off by 6, and the number of commits is correct, we can assume that this is either due to overzealous author grouping on our part or an author having multiple Github accounts.
...
Our methods for counting commits match Github's results. Despite the author discrepancy, the method appears to sufficiently accurate for the purposes of this analysis.
